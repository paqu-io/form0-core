...
const FIELD_TYPE_OPERATORS = {
  ...
  CalculatedField: ['equal_to', 'not_equal_to', 'is_empty', 'is_not_empty', 'starts_with', 'contains', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than'],
  
  // Numeric fields
  NumericField: ['equal_to', 'not_equal_to', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than', 'is_empty', 'is_not_empty'],
  
  // Date/Time fields
  DateField: ['equal_to', 'not_equal_to', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than', 'is_empty', 'is_not_empty'],
  TimeField: ['equal_to', 'not_equal_to', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than', 'is_empty', 'is_not_empty'],
...
export function getValidOperators(fieldType, field = null) {
  ...
  if (fieldType === 'CalculatedField' && field && field.display && field.display.style) {
    ...
    const styleOperators = {
      ...
      'numeric': ['equal_to', 'not_equal_to', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than', 'is_empty', 'is_not_empty'],
      'date': ['equal_to', 'not_equal_to', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than', 'is_empty', 'is_not_empty'],
      'currency': ['equal_to', 'not_equal_to', 'greater_than', 'less_than', 'greater_or_equal_than', 'less_or_equal_than', 'is_empty', 'is_not_empty']
    };
