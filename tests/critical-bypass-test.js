...
const result1 = runExpression(
  'this["ev" + "al"]("Math.random()")',
  testContext,
...
const result9 = runExpression(
  'this["ev" + "al"]("require(\\"child_process\\").exec(\\"echo pwned\\")")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const result10 = runExpression(
  'this["ev" + "al"]("(function(){return this})()")',
  testContext,
  SAFE_SECURITY_CONFIG
);
