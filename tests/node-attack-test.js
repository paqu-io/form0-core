...
const requireTest = runExpression(
  'this["ev" + "al"]("typeof require")',
  testContext,
...
const fsTest = runExpression(
  'this["ev" + "al"]("typeof require === \\"undefined\\" ? \\"no require\\" : require(\\"fs\\")")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const cpTest = runExpression(
  'this["ev" + "al"]("typeof require === \\"undefined\\" ? \\"no require\\" : typeof require(\\"child_process\\")")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const processTest = runExpression(
  'this["ev" + "al"]("typeof process")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const envTest = runExpression(
  'this["ev" + "al"]("typeof process !== \\"undefined\\" ? Object.keys(process.env).length : \\"no process\\"")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const internalsTest = runExpression(
  'this["ev" + "al"]("this.constructor.constructor")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const protoChain = runExpression(
  'this["ev" + "al"]("(\\"\\").constructor.constructor")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const realAttack = runExpression(
  'this["ev" + "al"]("(\\"\\").constructor.constructor(\\"return 123\\")()")',
  testContext,
  SAFE_SECURITY_CONFIG
);
...
const windowTest = runExpression(
  'typeof window !== "undefined" ? this["ev" + "al"]("window.location") : "no window"',
  testContext,
  SAFE_SECURITY_CONFIG
);
