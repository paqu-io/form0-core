...
The selected follow-up architecture is documented in
`UNTRUSTED_JAVASCRIPT_EXECUTION_ARCHITECTURE.md`. It preserves imperative
vanilla-JavaScript calculations and event scripts and explicitly does not adopt
